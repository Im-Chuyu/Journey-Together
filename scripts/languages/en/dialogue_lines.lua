...
M.replies = {
    ...
    describe_monkeytail = {
        "I'll pick the monkeytails nearby, scan again after five seconds, then gather reeds in the marsh.",
        "Got it. I'll clear the nearby monkeytails, then bring marsh reeds back to you.",
        "I'll gather monkeytails in batches and finish with reeds if the marsh has any left.",
        "I'll search this area carefully, wait for another scan, and won't leave nearby monkeytails behind.",
    },
    monkeytail_done = {
        "The monkeytails and reeds are gathered. I brought the materials back.",
        "I've checked the nearby monkeytails and returned with the reeds I could find.",
        "The gathered reeds are safe in my inventory and ready for you.",
        "Gathering is finished. I kept all the reeds together for you.",
    },
    monkeytail_none = {
        "There were no pickable monkeytails nearby, and I couldn't find reeds in the marsh.",
    ...
    affinity_name = {"Reach 100 affinity and you can give me a name."},
    affinity_locked = {"That needs {1} affinity before I can do it."},
    affinity_skin = {"I'll change outfits once we reach 50 affinity."},
